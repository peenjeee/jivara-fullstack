    ...
    <FormSection animated delay={index * 0.04} className="min-w-0">
      ...
      <div className="grid min-w-0 gap-4 sm:grid-cols-2">
        <FormField label="Nama Obat" htmlFor={fieldId("medicineName")} required>
          <input id={fieldId("medicineName")} name={fieldId("medicineName")} defaultValue={values.medicineName} className={SCHEDULE_INPUT_CLASS} placeholder="Nama obat" required aria-label="Nama Obat" />
        </FormField>
